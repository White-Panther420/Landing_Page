...
class Book{
    ...
    displayBook(){
        ...
        let book_title = createNewElement("p", "Book_Title", this.title)
        let book_author = createNewElement("p", "Book_author", this.author)
        let book_pages = createNewElement("p", "Book_Pages", this.numPages)
